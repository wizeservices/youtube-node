...
var YouTube = function() {
  ...
  */
  ...
  /**
  * Video data from ID with custom parts
  * @param {array} ids
  * @param {array} parts
  * @param {function} callback
  */
  self.getByIdCustomParts = function(ids, parts, callback) {
    var validate = self.validate();
    ...
    if (validate !== null) {
      ...
      for (var i in parts) {
        self.addPart(parts[i]);
      }

      self.addParam('part', self.getParts());
      self.addParam('id', ids.join(','));
  ...
  /**
  * Author data from ID with custom parts
  * @param {array} ids
  * @param {array} parts
  * @param {function} callback
  */
  self.getChannelByIdCustomParts = function(ids, parts, callback) {
    var validate = self.validate();
  ...
  * @param {function} callback
  */
  self.searchOnlyIds = function(query, maxResults, callback) {
    var validate = self.validate();
